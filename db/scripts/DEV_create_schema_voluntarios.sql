...
-- -----------------------------------------------------
-- Table `voluntarios`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `voluntarios`.`user` ;

CREATE TABLE IF NOT EXISTS `voluntarios`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Data for table `voluntarios`.`participacoes`
-- -----------------------------------------------------
START TRANSACTION;
USE `voluntarios`;
INSERT INTO `voluntarios`.`participacoes` (`voluntario_id`, `acao_id`) VALUES (1, 1);
INSERT INTO `voluntarios`.`participacoes` (`voluntario_id`, `acao_id`) VALUES (1, 2);
INSERT INTO `voluntarios`.`participacoes` (`voluntario_id`, `acao_id`) VALUES (2, 1);
INSERT INTO `voluntarios`.`participacoes` (`voluntario_id`, `acao_id`) VALUES (2, 2);
INSERT INTO `voluntarios`.`participacoes` (`voluntario_id`, `acao_id`) VALUES (2, 3);
INSERT INTO `voluntarios`.`participacoes` (`voluntario_id`, `acao_id`) VALUES (2, 4);
